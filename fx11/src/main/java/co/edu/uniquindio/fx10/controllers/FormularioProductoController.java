...
public class FormularioProductoController {
    ...
    /**
     * Establece el controlador del listado para poder regresar
     */
    public void setListadoProductoController(ListadoProductoController listadoProductoController) {
        ...
        this.contenedorPrincipal = listadoProductoController.getContenedorPrincipal();
    }
    ...
    private void onGuardarProducto() {
        ...
        try {
            ...
            // Volver al dashboard o al listado según desde donde se llamó
            if (dashboardController != null) {
                dashboardController.restaurarVista();
            } else if (listadoProductoController != null) {
                volverAlListado();
            }
    ...
    private void volverAlListado() {
        try {
            ...
            if (listadoProductoController != null && listadoProductoController.getDashboardController() != null) {
                controller.setDashboardController(listadoProductoController.getDashboardController());
            }
