...
public class Estudiantes {
    ...
    public Estudiantes(String nombre, int edad, String genero, int identificacion, String alergias , String nombreAcudiente, String contactoAcudiente) {
        this.nombre = nombre;
        this.edad = edad;
        this.genero = genero;
    ...
    public String toString() {
        ...
        public static void main(String[] args) {
            Estudiantes nino1 = new Estudiantes("Juan", 5, "Masculino", 123456, "Ninguna", "Maria Perez", "3123456789");
